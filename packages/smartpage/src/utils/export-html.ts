...
/** Fingerprint attributes for exported HTML documents */
const FINGERPRINT_ATTRS = `data-smartpage-origin="true" data-smartpage-version="${SMARTPAGE_VERSION}"`
...
export function exportToPdfHtml(editorHtml: string, options: ExportOptions = {}): string {
  ...
  return `<!DOCTYPE html>
<html lang="en" ${FINGERPRINT_ATTRS}>
<head>
  <meta charset="UTF-8">
