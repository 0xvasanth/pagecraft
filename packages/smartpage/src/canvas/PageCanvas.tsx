      ...
      <div className="editor-pages-container" style={{ position: 'relative', minHeight: totalHeight }}>
        ...
        {pages.map((page, i) => (
          <div key={`hf-${i}`}>
            {/* Header */}
            <div
              className="smartpage-hf smartpage-hf--header"
              style={{
                position: 'absolute',
                top: page.top,
                left: '50%',
            ...
            >
              {i === 0 ? (
                ...
                <div className="smartpage-hf-display" onDoubleClick={handleStartEditHeader}>
                  {hasHeaderContent ? (
                    <SafeHtmlPreview html={header} className="smartpage-hf-display__content" />
                  ) : (
                    <span className="smartpage-hf-display__placeholder">Double-click to add header</span>
                  )}
                </div>
              )}
            </div>
            ...
            {/* Footer */}
            <div
              className="smartpage-hf smartpage-hf--footer"
              style={{
                position: 'absolute',
            ...
            >
              {i === 0 ? (
                ...
                <div className="smartpage-hf-display" onDoubleClick={handleStartEditFooter}>
                  {hasFooterContent ? (
                    <SafeHtmlPreview html={footer} className="smartpage-hf-display__content" />
                  ) : (
                    <span className="smartpage-hf-display__placeholder">Double-click to add footer</span>
                  )}
                </div>
              )}
            </div>
